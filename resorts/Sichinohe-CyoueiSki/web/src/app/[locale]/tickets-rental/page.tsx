...
import { AwardContentSection } from "@/components/AwardContentSection";
...
export default async function TicketsRentalPage() {
  ...
  return (
    ...
    >
      ...
      <div>
        <AwardContentSection title={t("ticketsSection")}>
        ...
        <AwardContentSection title={t("rentalSection")}>
        ...
        <AwardContentSection title={t("paymentSection")}>
